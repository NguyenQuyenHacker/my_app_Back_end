...
from app.routers.client import customer_info_router, customer_home_router, account_router, transfer_router, user_thread_router,auth_client_router, agent_proxy_router, settings_router, savings_router, statistics_router
